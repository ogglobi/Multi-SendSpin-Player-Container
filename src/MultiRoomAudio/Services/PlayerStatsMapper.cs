...
internal static class PlayerStatsMapper
{
    ...
    /// Matches the entry threshold in BufferedAudioSampleSource (35ms).
    /// </summary>
    private const double SyncToleranceMs = 35.0;
    ...
    private static SyncCorrectionStats BuildSyncCorrectionStats(AudioBufferStats? bufferStats)
    {
        ...
        return new SyncCorrectionStats(
            ...
            ThresholdMs: 35  // Entry threshold with hysteresis (exits at 10ms)
        );
    }
